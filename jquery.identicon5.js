...
Original Author: http://FrancisShanahan.com
...
New Usage:
Alternative way to render the identicon directly in the image tag. (Without creating an additional canvas element in the DOM)

#('img').identicon5({dataattr: 'md5'});

*/
(function ($) {
    $.fn.identicon5 = function (options) {
        // default options
        var settings = jQuery.extend({ rotate: true, size:32, dataattr: 'md5' }, options);
        ...
        return this.each(function () {
            ...
            var hash = $(this).data(settings.dataattr);
            ...
            if (canvas.getContext) {
                ...
                $(this).attr('src', 'http://www.gravatar.com/avatar/' + hash  + '?s=' + settings.size + '&d=identicon&r=PG');
            }
        });
    };
})(jQuery);
